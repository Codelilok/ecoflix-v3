...
import {
  ...
  ChevronDown, Tv, Users, ArrowLeft, X, Loader2, Minus, Film,
} from "lucide-react";
  ...
  return (
    <Layout>
      ...
      <div className="max-w-screen-2xl mx-auto w-full px-6 md:px-14 py-8 space-y-10">
        ...
        {/* Trailer */}
        {show.trailer?.videoAddress?.url && (
          <section>
            <div className="flex items-center gap-2 mb-3">
              <Film className="h-5 w-5 text-red-500" />
              <h3 className="text-xl font-bold text-white">Trailer</h3>
            </div>
            <div className="relative w-full max-w-3xl rounded-2xl overflow-hidden border border-zinc-800 bg-black shadow-2xl shadow-black/40">
              <video
                src={show.trailer.videoAddress.url}
                controls
                playsInline
                preload="metadata"
