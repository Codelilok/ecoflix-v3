                ...
                <div className="flex flex-wrap justify-center gap-2.5 max-w-2xl mx-auto">
                  {everyoneSearching.map((item, i) => (
                    <button
                      ...
                      className="bg-zinc-800 hover:bg-red-600/20 hover:text-red-400 hover:border-red-500/50 border border-zinc-700 px-4 py-2 rounded-full text-sm font-medium text-gray-200 transition-all active:scale-95"
                    >
                      {item.title}
                    </button>
                  ))}
