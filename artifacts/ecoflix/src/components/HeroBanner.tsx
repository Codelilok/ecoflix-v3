...
import { Play, ChevronLeft, ChevronRight, Share2, Dice6 } from "lucide-react";
    ...
    <>
      ...
      >
          ...
          <div className="max-w-lg">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-red-600/90 text-white px-5 py-3 rounded font-bold text-base md:text-lg hover:bg-red-600 transition-colors backdrop-blur-sm active:scale-95"
              >
        ...
        {items.length > 1 && (
          <>
            <button
              onClick={() => { if (intervalRef.current) clearInterval(intervalRef.current); goPrev(); }}
            ...
            <button
              onClick={() => { if (intervalRef.current) clearInterval(intervalRef.current); goNext(); }}
