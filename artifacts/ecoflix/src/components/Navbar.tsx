...
import { Search, Heart, Menu, X, History, Home, BarChart2, Grid, Clock, Users, Dice6, Download, Share, ArrowUpFromLine, Wifi, FolderDown, Tv2 } from "lucide-react";
...
export function Navbar() {
  ...
  const menuLinks = [
    ...
    { name: "Anime", path: "/anime", icon: Tv2 },
    { name: "Social Downloader", path: "/downloader", icon: FolderDown },
